...
public:
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(fUseBlackTheme ? QColor(79, 194, 196) : option.palette.color(QPalette::Text));
    ...
    filter(0)
{
    ...
    if (fUseBlackTheme)
    {
        const char* whiteLabelQSS = "QLabel { color: rgb(79, 194, 196); }";
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("DIMI")
    updateDisplayUnit();
}
